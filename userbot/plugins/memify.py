...
async def _(event):
    ...
    if reply_message.sender.bot:
       ...
       await event.edit("```MemeFying this image.```")
    ...
    async with borg.conversation("@MemeAutobot") as bot_conv:
          ...
          if "Okay..." in response.text:
            await event.edit("```This is not an image! This will take some tym to convert to image```")
            thumb = None
            ...
            await event.delete()
            sax = await borg.send_message(event.chat_id, "`Memefied!`")
