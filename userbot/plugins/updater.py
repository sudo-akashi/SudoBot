...
OFFICIAL_UPSTREAM_REPO = "https://github.com/sudo-akashi/SudoBot/"
...
async def deploy_start(tgbot, message, refspec, remote):
    ...
    await message.edit("Updating and Deploying New Branch. Please wait for 5 minutes then use `.alive` to check if the bot is working or not.")
