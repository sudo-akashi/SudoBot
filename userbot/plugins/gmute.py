...
async def startgmute(event):
    ...
    if event.pattern_match.group(1) is not None:
        ...
        return await event.edit("Please reply to a user or add their ID into the command to gmute them.")
    ...
    try:
        ...
        await event.edit("Muted Globally! You can't message in the groups I'm an admin.")
...
async def endgmute(event):
    ...
    if event.pattern_match.group(1) is not None:
        ...
        return await event.edit("Please reply to a user or add their ID into the command to ungmute them.")
    chat_id = event.chat_id
