...
if len(argv) not in (1, 3, 4):
    ...
    if Var.TG_BOT_USER_NAME_BF_HER is not None:
        ...
        print("Connection Established Succeessfully")
        print("Starting SudoBot")
...
print("SudoBot is up. Type .alive in any chat.")
